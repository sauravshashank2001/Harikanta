...
function Facilities() {
  return (
    <div>
      <div class="font-[sans-serif] dark:bg-slate-900 px-4">
      <div class="max-w-7xl mx-auto pb-4">
        <h2 class="text-white sm:text-4xl text-2xl font-bold text-center mb-16 pt-4">Facilites</h2>
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">24-hours Wifi</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Camping </h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Enjoy the exclusive jungle safari and camping in jimm corbett.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Easy Commute</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">We faciltates in pickup and drop from railway station and airport. </p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Experience the best experience of your lifetime in arms of nature.</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Candle Light Dinner</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">We arrange aesthetic candle light dinner</p>
          </div>
          ...
          <div class="rounded-xl group p-8 text-center hover:bg-white text-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <h3 class="text-xl font-semibold mb-3">Lifetime Experience</h3>
            <p class="text-gray-300 group-hover:text-gray-500 text-sm">Beast experience of you life</p>
          </div>
        </div>
      </div>
    </div>
